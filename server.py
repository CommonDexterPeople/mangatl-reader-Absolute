...
# ─── Page geometry and bubble merging ────────────────────────────────────────
# Panel-border detection, bubble contour/component tracing, the fused-bubble
# waist veto and the fragment-merging pipeline used to live here, inline, as
# ~1,420 lines ending in one 739-line _merge_bubble_regions(). They now live in
# mtl/geometry.py (shape primitives) and mtl/merge.py (the merge stages that
# consult them), imported at the top of this file and re-exported below so
